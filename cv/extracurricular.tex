...
\cventry
  ...
  {Fall 2020 - Spring 2016}
  {
    \begin{cvitems}
      ...
      \else
      \item {Helped plan club meetings with goal of increasing diversity in the field of Computer Science, and gave tech talks on various technology subjects} % Should prob have some more here as we do more
      \fi
    \end{cvitems}
  }
  {}
...
%---------------------------------------------------------
    ...
    {Boy Scouts of America - Lone Tree, CO} % Organization/group
    {Lone Tree} % Location
